node {
   ...
   stage('Push') {
      withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'a03d0639-7f59-4760-a5ad-dc3066f8fee5', usernameVariable: 'GIT_USERNAME', passwordVariable: 'GIT_PASSWORD']]) {
